...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('companies', function (Blueprint $table) {
            ...
            $table->unsignedInteger('edrpou')->nullable(); // ЄДРПОУ (8 цифр)
            $table->unsignedInteger('inn')->nullable(); // ІНН (10 цифр)
            $table->string('registration_number')->nullable();  // Номер свидетельства о регистрации
            $table->string('registration_date')->nullable(); // Дата регистрации
